...
require (
	git.eth4.dev/golibs/coders v1.1.0
	git.eth4.dev/golibs/containers v1.1.0
	git.eth4.dev/golibs/deps v1.2.2
	git.eth4.dev/golibs/errors v1.2.1
	git.eth4.dev/golibs/execs v1.1.0
	git.eth4.dev/golibs/iorw v1.1.0
	git.eth4.dev/golibs/network v1.1.0
)

require (
	git.eth4.dev/golibs/appcache v1.1.0 // indirect
	git.eth4.dev/golibs/appscenario v1.1.0 // indirect
	git.eth4.dev/golibs/colors v1.1.0 // indirect
	git.eth4.dev/golibs/confctl v1.1.0 // indirect
	...
	git.eth4.dev/golibs/storage v1.1.0 // indirect
